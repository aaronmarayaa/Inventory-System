...
function closeModal(modalId) {
    ...
    if (modalId === 'confirmActionModal' && !isConfirmingAction) {
...
function closeAdminUpdateItemModal() {
    closeModal('adminUpdateItemModal');
}

function closeAdminViewItemModal() {
    closeModal('adminViewItemModal');
}

function closeAdminResetUserPasswordModal() {
    closeModal('adminResetUserPasswordModal');
}
