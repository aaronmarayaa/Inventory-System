<?php
    ...
    $imagePath = $rootPrefix . 'assets/img/error-unauthorized.png';
    $primaryLink = $rootPrefix . 'index.php';
...
<head>
    ...
    <title>401 Unauthorized | Chocolate Inventory</title>
...
<body class="error-page">
    <main class="error-card" aria-label="401 Unauthorized">
        <h1 class="error-title">Login required</h1>
        ...
        <p class="error-message">You need to log in before opening this page.</p>

        <div class="error-hint">
            <strong>Hint:</strong> Your session may have expired. Please log in again, then try opening the page one more time.
        </div>
