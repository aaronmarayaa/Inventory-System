<?php
    ...
    $imagePath = $rootPrefix . 'assets/img/error-forbidden.png';
...
<head>
    ...
    <title>403 Forbidden | Chocolate Inventory</title>
...
<body class="error-page">
    <main class="error-card" aria-label="403 Forbidden">
        <h1 class="error-title">Access not allowed</h1>
        ...
        <p class="error-message">Your account does not have permission to open this page.</p>

        <div class="error-hint">
            <strong>Hint:</strong> You may be logged in, but your current role cannot access this section. Contact the super admin if this seems wrong.
        </div>
